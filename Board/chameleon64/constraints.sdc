...
create_generated_clock -name fastclk -source [get_pins {U00|altpll_component|auto_generated|pll1|clk[1]}]
...
set_input_delay -clock fastclk -max 1.0 [get_ports mux_q*]
set_input_delay -clock fastclk -min 0.5 [get_ports mux_q*]
set_input_delay -clock fastclk -min 0.5 [get_ports spi_miso]
set_input_delay -clock fastclk -max 1.0 [get_ports spi_miso]
...
set_output_delay -clock fastclk -max 1.0 [get_ports mux*]
set_output_delay -clock fastclk -min 0.5 [get_ports mux*]
